### 🎮 SideStory「月行水上」SR-EX 不适配多作业模式 (NEW!!!)

SR-EX 为异形关卡界面，多作业模式若要适配需要同时改动 开始行动、关卡名复核、切换突袭 等多处流程，本次不做适配。

如需在 SR-EX 关卡使用自动战斗，请手动选关并点击 ｢开始行动｣，在随后的编队界面启动 MAA 即可。

作业集仍可正常导入，在作业列表中右键目标作业的图标，即可快速切换至该作业的单作业模式。

----

### 黑流树海-疯狂的鹿刷钱

~~地图太复杂了，先整个快速刷钱的脚本~~ 虽然自动肉鸽中的刷钱策略已经出了，但这玩意还挺好用的，先留着
